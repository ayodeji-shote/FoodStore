...
namespace FoodStore.Data.Mocks
{
    ...
    {
        // we need to reference the mock category repository because the drinks have a property named category
            ...
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        ImageUrl = "https://shorturl.at/eQR56",
                        Stock = true,
                        IsFavorite = true,
                        ImageThumbnailUrl = "https://shorturl.at/eQR56"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "https://gcdnb.pbrd.co/images/XrtEAxD5OpFV.png?o=1",
                        Stock = true,
                        IsFavorite = false,
                        ImageThumbnailUrl = "https://gcdnb.pbrd.co/images/XrtEAxD5OpFV.png?o=1"
                    },
                    new Drink {
                        Name = "Tequila ",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "https://gcdnb.pbrd.co/images/GSde6HW0XEfR.png?o=1",
                        Stock = true,
                        IsFavorite = false,
                        ImageThumbnailUrl = "https://gcdnb.pbrd.co/images/GSde6HW0XEfR.png?o=1"
                    },
                    new Drink {
                        Name = "Water ",
                        Price = 12.95M, ShortDescription = "Its just water",
                        LongDescription = "water, a substance composed of the chemical elements hydrogen and oxygen and existing in gaseous, liquid, and solid states.",
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "https://gcdnb.pbrd.co/images/D6z9v16gYGip.png?o=1",
                        Stock = true,
                        IsFavorite = false,
                        ImageThumbnailUrl = "https://gcdnb.pbrd.co/images/D6z9v16gYGip.png?o=1"
                    },
                    new Drink
                    {
                        Name = "Juice ",
                        ...
                        ImageUrl = "https://gcdnb.pbrd.co/images/SMjg3LBhOMPq.png?o=1",
                        Stock = true,
                        IsFavorite = false,
                        ImageThumbnailUrl = "https://gcdnb.pbrd.co/images/SMjg3LBhOMPq.png?o=1"
                    }
                };
            }
        }
        public IEnumerable<Drink> FavoriteDrink { get; }
